...
victim-2:     file format elf32-i386
...
08048324 <_init>:
 8048324:	53                   	push   ebx
 8048325:	83 ec 08             	sub    esp,0x8
 8048328:	e8 00 00 00 00       	call   804832d <_init+0x9>
 804832d:	5b                   	pop    ebx
 804832e:	81 c3 c7 1c 00 00    	add    ebx,0x1cc7
 8048334:	8b 83 fc ff ff ff    	mov    eax,DWORD PTR [ebx-0x4]
...
080483f0 <__do_global_dtors_aux>:
 ...
 80483f7:	80 3d 3c a0 04 08 00 	cmp    BYTE PTR ds:0x804a03c,0x0
 80483fe:	75 3f                	jne    804843f <__do_global_dtors_aux+0x4f>
 8048400:	a1 40 a0 04 08       	mov    eax,ds:0x804a040
 8048405:	bb 18 9f 04 08       	mov    ebx,0x8049f18
 804840a:	81 eb 14 9f 04 08    	sub    ebx,0x8049f14
 ...
 8048423:	a3 40 a0 04 08       	mov    ds:0x804a040,eax
 8048428:	ff 14 85 14 9f 04 08 	call   DWORD PTR [eax*4+0x8049f14]
 804842f:	a1 40 a0 04 08       	mov    eax,ds:0x804a040
 8048434:	39 d8                	cmp    eax,ebx
 8048436:	72 e8                	jb     8048420 <__do_global_dtors_aux+0x30>
 8048438:	c6 05 3c a0 04 08 01 	mov    BYTE PTR ds:0x804a03c,0x1
...
08048450 <frame_dummy>:
 ...
 8048456:	a1 1c 9f 04 08       	mov    eax,ds:0x8049f1c
 ...
 8048468:	c7 04 24 1c 9f 04 08 	mov    DWORD PTR [esp],0x8049f1c
...
08048480 <main>:
 ...
 804849e:	a1 44 a0 04 08       	mov    eax,ds:0x804a044
 80484a3:	8b 1d 48 a0 04 08    	mov    ebx,DWORD PTR ds:0x804a048
 80484a9:	29 d8                	sub    eax,ebx
 80484ab:	3d 93 88 01 00       	cmp    eax,0x18893
...
080484d0 <__libc_csu_init>:
 ...
 80484d9:	81 c3 1b 1b 00 00    	add    ebx,0x1b1b
 80484df:	83 ec 1c             	sub    esp,0x1c
 80484e2:	8b 6c 24 30          	mov    ebp,DWORD PTR [esp+0x30]
 80484e6:	8d bb 18 ff ff ff    	lea    edi,[ebx-0xe8]
 80484ec:	e8 33 fe ff ff       	call   8048324 <_init>
 80484f1:	8d 83 18 ff ff ff    	lea    eax,[ebx-0xe8]
 80484f7:	29 c7                	sub    edi,eax
 80484f9:	c1 ff 02             	sar    edi,0x2
 ...
 804851b:	ff 94 b3 18 ff ff ff 	call   DWORD PTR [ebx+esi*4-0xe8]
 8048522:	83 c6 01             	add    esi,0x1
